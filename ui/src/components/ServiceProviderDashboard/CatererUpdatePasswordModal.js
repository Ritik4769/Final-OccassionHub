// CatererUpdatePasswordModal.js-// export default EditProfileModal;
...
function CatererUpdatePasswordModal(props) {
    ...
    const handleSubmitProfileUpdateData = async (event) => {
        ...
        try {
            ...
            const result = await axios.post(caterre_requestUrl + "/updateCatererPassword", updatedPassData);
...
export default CatererUpdatePasswordModal;
